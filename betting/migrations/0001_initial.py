# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-11 12:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_coins', models.IntegerField(default=0, verbose_name='F coins')),
                ('affi_code', models.CharField(blank=True, default='', max_length=64, null=True, verbose_name='Affiliate Code')),
                ('can_buy', models.BooleanField(default=False, verbose_name='Can Buy')),
                ('is_new', models.BooleanField(default=True, verbose_name='Is New')),
                ('higher', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lower', to=settings.AUTH_USER_MODEL, verbose_name='Higher')),
                ('steamer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='affiliate', to=settings.AUTH_USER_MODEL, verbose_name='Steamer')),
            ],
        ),
        migrations.CreateModel(
            name='Announcement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(blank=True, max_length=64)),
                ('content_html', DjangoUeditor.models.UEditorField()),
                ...
                ('pic', models.ImageField(blank=True, null=True, upload_to='images/overview/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('href', models.URLField(blank=True, default=None, null=True, verbose_name='Target Url')),
                ('pic', models.ImageField(upload_to='images/carousel/', verbose_name='Picture(width:1135)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steamer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='F_coins_records', to=settings.AUTH_USER_MODEL, verbose_name='Steamer')),
            ],
            options={
                'verbose_name': 'F coins Records',
                'verbose_name_plural': 'F coins Records',
            },
        ),
        migrations.CreateModel(
            name='GiveAway',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('F_coins_record', models.ManyToManyField(blank=True, default=None, related_name='items', to='betting.FcoinsRecord', verbose_name='F coins Record')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('site', models.IntegerField(choices=[(0, 'douyu')], default=0)),
