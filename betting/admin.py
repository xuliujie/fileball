...
admin.site.register(models.FcoinsRecord, models_admin.FcoinsRecordAdmin)
admin.site.register(models.BettingBot, models_admin.BettingBotAdmin)
admin.site.register(models.Article, models_admin.ArticleAdmin)
admin.site.register(models.Video, models_admin.VideoAdmin)
admin.site.register(models.Affiliate, models_admin.AffiliateAdmin)
admin.site.register(models.Carousel, models_admin.CarouselAdmin)
